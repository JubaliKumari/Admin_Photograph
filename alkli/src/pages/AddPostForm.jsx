      ...
      <div className="w-full max-w-5xl mx-auto bg-white p-8 rounded-2xl shadow-2xl dark:bg-gray-500 text-gray-800 dark:text-white">
        ...
        >
          ...
          <div>
            ...
            />
            {errors.heading && (
              <p className="text-red-500 dark:text-red-400 text-sm">{errors.heading.message}</p>
            )}
          </div>

          {/* Image */}
          <div>
            <label className="flex flex-col items-center gap-4 mb-1 font-medium">Upload Image
              ...
              <input
                ...
                {...register("image", {
                  ...
                  onChange: (e) => {               // 👈 onChange inside register — no conflict
        ...
        {posts.length === 0 ? (
          ...
          posts.map((post, index) => (
            ...
            >
              ...
              <p className="text-gray-600 text-sm dark:text-gray-300">{post.description}</p>
            </div>
          ))
        )}
      </div>
